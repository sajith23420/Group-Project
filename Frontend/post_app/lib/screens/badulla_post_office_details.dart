...
class BadullaPostOfficeDetails extends StatelessWidget {
  const BadullaPostOfficeDetails({super.key});

  final List<Map<String, dynamic>> postOffices = const [
    {
      'name': 'Badulla Post Office',
      'address': 'Main Street, Badulla 90000',
      'phone': '+94 55 2 222222',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Badulla Post Offices'),
