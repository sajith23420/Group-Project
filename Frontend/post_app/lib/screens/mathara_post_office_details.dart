...
class MatharaPostOfficeDetails extends StatelessWidget {
  const MatharaPostOfficeDetails({super.key});

  final List<Map<String, dynamic>> postOffices = const [
    {
      'name': 'Matara Main Post Office',
      'address': 'Anagarika Dharmapala Mawatha, Matara 81000',
      'phone': '+94 41 2 222222',
    ...
    {
      'name': 'Walgama Post Office',
      'address': 'Walgama, Matara 81000',
      'phone': '+94 41 2 333444',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Matara Post Offices'),
          ...
          children: [
            SizedBox(
              ...
              child: ClipRRect(
                ...
                child: FlutterMap(
                  options: MapOptions(
                    initialCenter: LatLng(5.9485, 80.5353), // Matara
                    initialZoom: 13.5,
                  ),
                  children: [
                    TileLayer(
