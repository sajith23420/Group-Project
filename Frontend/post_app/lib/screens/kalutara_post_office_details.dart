...
class KalutaraPostOfficeDetails extends StatelessWidget {
  const KalutaraPostOfficeDetails({super.key});

  final List<Map<String, dynamic>> postOffices = const [
    {
      'name': 'Kalutara Post Office',
      'address': 'Main Street, Kalutara 12000',
      'phone': '+94 34 2 222222',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Kalutara Post Offices'),
