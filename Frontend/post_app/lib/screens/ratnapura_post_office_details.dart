...
class RatnapuraPostOfficeDetails extends StatelessWidget {
  const RatnapuraPostOfficeDetails({super.key});

  final List<Map<String, dynamic>> postOffices = const [
    {
      'name': 'Ratnapura Post Office',
      'address': 'Main Street, Ratnapura 70000',
      'phone': '+94 45 2 222222',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Ratnapura Post Offices'),
