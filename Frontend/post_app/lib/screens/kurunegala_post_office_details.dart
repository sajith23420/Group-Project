...
class KurunegalaPostOfficeDetails extends StatelessWidget {
  const KurunegalaPostOfficeDetails({super.key});

  final List<Map<String, dynamic>> postOffices = const [
    {
      'name': 'Kurunegala Post Office',
      'address': 'Main Street, Kurunegala 60000',
      'phone': '+94 37 2 222222',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Kurunegala Post Offices'),
          ...
          children: [
            SizedBox(
              ...
              child: ClipRRect(
                ...
                child: FlutterMap(
                  options: MapOptions(
                    initialCenter: LatLng(7.4863, 80.3647), // Kurunegala
                    initialZoom: 13.5,
                  ),
                  children: [
                    TileLayer(
