...
class AnuradhapuraPostOfficeDetails extends StatelessWidget {
  const AnuradhapuraPostOfficeDetails({super.key});

  final List<Map<String, dynamic>> postOffices = const [
    {
      'name': 'Anuradhapura Main Post Office',
      'address': 'Maithripala Senanayake Mawatha, Anuradhapura 50000',
      'phone': '+94 25 2 222222',
    ...
    {
      'name': 'New Town Post Office',
      'address': 'New Town, Anuradhapura 50000',
      'phone': '+94 25 2 333444',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Anuradhapura Post Offices'),
          ...
          children: [
            SizedBox(
              ...
              child: ClipRRect(
                ...
                child: FlutterMap(
                  options: MapOptions(
                    initialCenter: LatLng(8.3114, 80.4037), // Anuradhapura
                    initialZoom: 13.5,
                  ),
                  children: [
                    TileLayer(
