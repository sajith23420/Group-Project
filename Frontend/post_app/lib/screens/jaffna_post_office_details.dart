...
class JaffnaPostOfficeDetails extends StatelessWidget {
  const JaffnaPostOfficeDetails({super.key});

  final List<Map<String, dynamic>> postOffices = const [
    {
      'name': 'Jaffna Main Post Office',
      'address': 'Kankesanthurai Road, Jaffna 40000',
      'phone': '+94 21 2 222222',
    ...
    {
      'name': 'Nallur Post Office',
      'address': 'Nallur, Jaffna 40000',
      'phone': '+94 21 2 333444',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Jaffna Post Offices'),
          ...
          children: [
            SizedBox(
              ...
              child: ClipRRect(
                ...
                child: FlutterMap(
                  options: MapOptions(
                    initialCenter: LatLng(9.6685, 80.0074), // Jaffna
                    initialZoom: 13.5,
                  ),
                  children: [
                    TileLayer(
                        ...
                        children: [
                          Text(
                            ...
                            style: const TextStyle(
                              ...
                              color: Color.fromARGB(255, 20, 44, 80),
                            ),
                          ),
