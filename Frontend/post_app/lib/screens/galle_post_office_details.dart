...
class GallePostOfficeDetails extends StatelessWidget {
  const GallePostOfficeDetails({super.key});

  final List<Map<String, dynamic>> postOffices = const [
    {
      'name': 'Galle Post Office',
      'address': 'Church Street, Galle 80000',
      'phone': '+94 91 2 222222',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Galle Post Offices'),
          ...
          children: [
            SizedBox(
              ...
              child: ClipRRect(
                ...
                child: FlutterMap(
                  options: MapOptions(
                    initialCenter: LatLng(6.0320, 80.2170), // Galle
                    initialZoom: 13.5,
                  ),
                  children: [
                    TileLayer(
